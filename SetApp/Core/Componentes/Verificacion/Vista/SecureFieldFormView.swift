//
//  SecureFieldFormView.swift
//  Validation
//
//  Created by Omar Bonilla Varela on 20/4/22.
//

import SwiftUI

/* Para el campo contraseña */
struct SecureFieldFormView: View {
    ...
    let textComponent: SecureTextFormComponent
...
struct SecureFieldFormView_Previews: PreviewProvider {
    
    static var previews: some View {
        
        SecureFieldFormView(textComponent: .init(id: .email,
                                                 placeholder: ""))
